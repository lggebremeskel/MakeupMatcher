...
def initialize_databases():
    ...
    directory_reader(current_directory +
                     "\\Foundations\FENTY PRO FILTR SOFT MATTE", Fenty_database)
    directory_reader(current_directory +
                     "\\Foundations\LANCOME TEINT IDOLE ULTRA 24H LONG WEAR FOUNDATION", Lancome_database)
    directory_reader(current_directory +
                     "\\Foundations\DIOR FOREVER", Dior_database)
